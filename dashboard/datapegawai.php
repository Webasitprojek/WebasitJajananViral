...
$jumlahdataperhalaman = 3;
    $cara = count(query("SELECT * FROM user WHERE user.username LIKE '%$search%'"));
    $jumlahalaman = ceil($cara / $jumlahdataperhalaman);
    $halamanaktif = (isset(  $_GET["halaman"]) ) ? $_GET["halaman"] : 1;
    $awaldata = ($jumlahdataperhalaman * $halamanaktif) - $jumlahdataperhalaman;
    $caratampil = query("SELECT * FROM user WHERE user.username LIKE '%$search%' LIMIT $awaldata , $jumlahdataperhalaman");


if(isset($_POST["caripega"])){
    $_SESSION['search'] = $_POST["caripega"];
...
<body>
    ...
    <div class="container">
        ...
        <!-- SIDEBAR END -->
         ...
         <div class="main">
            <div class="topbar">
                ...
                <div class="search">
                    <form action="datapegawai.php" id="formcaripega" method="post">
                    <label>
                        <input type="text" placeholder="Search here" name="caripega" id="caripega">
            ...
            <div class="tom">
            <button onclick="window.location.href='tambahpegawai.php'">Tambah</button>     
            </div>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            echo '<img src="data:image/jpeg;base64,' . $base64Image . '" style="max-width: 180px; max-height: 180px;" />';
                            ?>
                        ...
                        <td>
                            <div class="aksibox">
                                <div class="editbox">
                                    <a href="editpegawai.php?id=<?php echo $row["id"]; ?>">EDIT</a>
                                </div>
                                <div class="hapusbox">
                                    <a href="hapuspega.php?username=<?php echo $row["username"]; ?>" onclick="return confirm('Yakin Ingin Menghapus Data?');">HAPUS</a>
                                </div>
                            </div>
                        </td>
                    </tr>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('caripega').addEventListener('keypress', function(e) {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    document.getElementById('formcaripega').submit();
                }
            });
        });
    </script>  
