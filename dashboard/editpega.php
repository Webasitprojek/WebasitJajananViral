...
<!-- Navbar Start -->
<nav class="navbar">
    <a href="../dashboard/dashboard.php" class="navbar-logo">SI<span>CEDAS</span></a>
        ...
        <div class="row">
            ...
            <div class="content">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <option disabled><?php echo $user_jk ?></option>
                    ...
                    <div class="input-group" id="fi">
                        ...
                        <input type="file" placeholder="Unggah Foto" required name="ung" id="ung">
                    </div>
